...
function simpleble_adapter_get_handle(index: size_t): simpleble_adapter_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT void simpleble_adapter_release_handle(simpleble_adapter_t handle);
procedure simpleble_adapter_release_handle(handle: simpleble_adapter_t); cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT char* simpleble_adapter_identifier(simpleble_adapter_t handle);
function simpleble_adapter_identifier(handle: simpleble_adapter_t): PChar; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT char* simpleble_adapter_address(simpleble_adapter_t handle);
function simpleble_adapter_address(handle: simpleble_adapter_t): PChar; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_adapter_scan_start(simpleble_adapter_t handle);
function simpleble_adapter_scan_start(handle: simpleble_adapter_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_adapter_scan_stop(simpleble_adapter_t handle);
function simpleble_adapter_scan_stop(handle: simpleble_adapter_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_adapter_scan_is_active(simpleble_adapter_t handle, bool* active);
function simpleble_adapter_scan_is_active(handle: simpleble_adapter_t; var active: Boolean): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_adapter_scan_for(simpleble_adapter_t handle, int timeout_ms);
function simpleble_adapter_scan_for(handle: simpleble_adapter_t; timeout_ms: Integer): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT size_t simpleble_adapter_scan_get_results_count(simpleble_adapter_t handle);
function simpleble_adapter_scan_get_results_count(handle: simpleble_adapter_t): size_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_adapter_scan_get_results_handle(handle: simpleble_adapter_t; index: size_t): simpleble_peripheral_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT size_t simpleble_adapter_get_paired_peripherals_count(simpleble_adapter_t handle);
function simpleble_adapter_get_paired_peripherals_count(handle: simpleble_adapter_t): size_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_adapter_get_paired_peripherals_handle(handle: simpleble_adapter_t; index: size_t): simpleble_peripheral_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_adapter_set_callback_on_scan_start(handle: simpleble_adapter_t; callback: TCallbackScanStart; userdata: PPointer): simpleble_err_t;  cdecl; external SimpleBleExtLibrary;
...
function simpleble_adapter_set_callback_on_scan_stop(handle: simpleble_adapter_t; callback: TCallbackScanStop; userdata: PPointer): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_adapter_set_callback_on_scan_updated(handle: simpleble_adapter_t; callback: TCallbackScanUpdated; userdata: PPointer): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_adapter_set_callback_on_scan_found(handle: simpleble_adapter_t; callback: TCallbackScanFound; userdata: PPointer): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
// new types for callback functions
type
  TCallbackOnConnected = procedure(peripheral: simpleble_peripheral_t; userdata: PPointer);
  TCallbackOnDisconnected = procedure(peripheral: simpleble_peripheral_t; userdata: PPointer);
...
procedure simpleble_peripheral_release_handle(handle: simpleble_peripheral_t); cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT char* simpleble_peripheral_identifier(simpleble_peripheral_t handle);
function simpleble_peripheral_identifier(handle: simpleble_peripheral_t): PChar; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT char* simpleble_peripheral_address(simpleble_peripheral_t handle);
function simpleble_peripheral_address(handle: simpleble_peripheral_t): PChar; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT int16_t simpleble_peripheral_rssi(simpleble_peripheral_t handle);
function simpleble_peripheral_rssi(handle: simpleble_peripheral_t): Word; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_peripheral_connect(simpleble_peripheral_t handle);
function simpleble_peripheral_connect(handle: simpleble_peripheral_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_peripheral_disconnect(simpleble_peripheral_t handle);
function simpleble_peripheral_disconnect(handle: simpleble_peripheral_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_peripheral_is_connected(simpleble_peripheral_t handle, bool* connected);
function simpleble_peripheral_is_connected(handle: simpleble_peripheral_t; var connected: Boolean): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_peripheral_is_connectable(simpleble_peripheral_t handle, bool* connectable);
function simpleble_peripheral_is_connectable(handle: simpleble_peripheral_t; var connectable: Boolean): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_peripheral_is_paired(simpleble_peripheral_t handle, bool* paired);
function simpleble_peripheral_is_paired(handle: simpleble_peripheral_t; var paired: Boolean): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT simpleble_err_t simpleble_peripheral_unpair(simpleble_peripheral_t handle);
function simpleble_peripheral_unpair(handle: simpleble_peripheral_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT size_t simpleble_peripheral_services_count(simpleble_peripheral_t handle);
function simpleble_peripheral_services_count(handle: simpleble_peripheral_t): size_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_services_get(handle: simpleble_peripheral_t; index: size_t; services: simpleble_service_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;

//SIMPLEBLE_EXPORT size_t simpleble_peripheral_manufacturer_data_count(simpleble_peripheral_t handle);
function simpleble_peripheral_manufacturer_data_count(handle: simpleble_peripheral_t): size_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_manufacturer_data_get(handle: simpleble_peripheral_t; index: size_t; manufacturer_data: simpleble_manufacturer_data_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_read(handle: simpleble_peripheral_t; service: simpleble_uuid_t; characteristic: simpleble_uuid_t; var data: Byte; var data_length: size_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_write_request(handle: simpleble_peripheral_t; service: simpleble_uuid_t; characteristic: simpleble_uuid_t; var data: Byte; data_length: size_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_write_command(handle: simpleble_peripheral_t; service: simpleble_uuid_t; characteristic: simpleble_uuid_t; var data: Byte; data_length: size_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_notify(handle: simpleble_peripheral_t; service: simpleble_uuid_t; characteristic: simpleble_uuid_t; callback: TCallbackNotify; userdata: PPointer): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_indicate(handle: simpleble_peripheral_t; service: simpleble_uuid_t; characteristic: simpleble_uuid_t; callback: TCallbackIndicate; userdata: PPointer): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_unsubscribe(handle: simpleble_peripheral_t; service: simpleble_uuid_t; characteristic: simpleble_uuid_t):simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_read_descriptor(handle: simpleble_peripheral_t; service: simpleble_uuid_t; characteristic: simpleble_uuid_t; descriptor: simpleble_uuid_t; var data: UInt8; var data_length: size_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_write_descriptor(handle: simpleble_peripheral_t; service: simpleble_uuid_t; characteristic: simpleble_uuid_t; descriptor: simpleble_uuid_t; var data: UInt8; data_length: size_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_set_callback_on_connected(handle: simpleble_peripheral_t; callback: size_t; var userdata: size_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
...
function simpleble_peripheral_set_callback_on_disconnected(handle: simpleble_peripheral_t; callback: size_t; var userdata: size_t): simpleble_err_t; cdecl; external SimpleBleExtLibrary;
